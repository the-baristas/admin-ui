...
export class UsersService {
  ...
  public getAllUsers(page: number, size: number, activeOnly: boolean) {
    return this.http
      .get<Page<User>>(`${this.serverUrl}?page=${page}&size=${size}&activeOnly=${activeOnly}`, {
  ...
  public findUsersBySearchTerm(
    ...
    return this.http
      .get<Page<User>>(
        `${this.serverUrl}/search?term=${searchTerm}&page=${page}&size=${size}&activeOnly=${activeOnly}`,
        {
          headers: this.loginService.getHeadersWithToken()
        }
      )
