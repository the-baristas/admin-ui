...
describe('UsersService', () => {
    ...
    it('can test HttpClient.get', () => {
        httpClient
            .get<Data>('/data')
            .subscribe((data) => expect(data).toEqual(userData));
    ...
    it('Get user by email 404 should give error message', () => {
        ...
        expect(
            error.indexOf('A user with this email does not exist') >= 0
        ).toBeTruthy();
    });
    ...
    it('get user by username returns mock user data', () => {
        ...
        let mockRequest = httpTestingController.expectOne(
            apiUrl + '/username/' + userData[0].username
        );
        expect(mockRequest.cancelled).toBeFalsy();
        expect(mockRequest.request.responseType).toEqual('json');
        mockRequest.flush(userData[0]);
    ...
    it('Get user by username 404 should give error message', () => {
        ...
        expect(
            error.indexOf('A user with this username does not exist') >= 0
        ).toBeTruthy();
    });
    ...
    it('Get user by phone number 404 should give error message', () => {
        ...
        expect(
            error.indexOf('A user with this phone number does not exist') >= 0
        ).toBeTruthy();
    });
    ...
    it('Create user 400 should give error message', () => {
        ...
        expect(
            error.indexOf('One or more fields are invalid.') >= 0
        ).toBeTruthy();
    });
