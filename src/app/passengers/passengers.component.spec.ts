...
describe('PassengersComponent', () => {
  ...
  beforeEach(async () => {
    passengerServiceMock = jasmine.createSpyObj('PassengerService', ['findAll', 'search']);
  ...
  it('Create button should open modal', () => {
    ...
    let button = fixture.debugElement.nativeElement.querySelector("#create-new-button");
    button.click();
